...
class StoryBrain {
  ...
  void nextStory(int number) {
    if (number == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (number == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (number == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (number == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    } else if (number == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (number == 2 && _storyNumber == 2) {
      _storyNumber = 4;
